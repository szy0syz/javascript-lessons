...
var pattern6 = /(^[0-9|a-z|A-Z]*$)/;  // 补全该正则表达式
...
``` javascript
// 挑战七：日期格式：年-月-日
var pattern7 = /^\d{4}-(0[1-9]|1[0-2])-([0-2]\d|3[0-1])$/;  // 补全该正则表达式
...
var pattern8 = /^([0[1-9]|1\d|2[0-4]):[0-5]\d$/;  // 补全该正则表达式
...
var pattern9 = /^[1-9]\d{5}[1-2]\d{3}(0[1-9]|1[0-2])[0-3]\d{4}[0-9|X]$/;  // 补全该正则表达式
